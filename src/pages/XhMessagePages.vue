...
<!-- 循环选项卡 打开注释-->
<!--      <van-tabs background="#f7f7f7" v-model="active" swipeable>-->
...
<style scoped>
  ...
  .XhMessagePages .xinhua_header a{
